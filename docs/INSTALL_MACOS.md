...
Den seneste macOS-pakke udgives sammen med Windows Setup.exe under samme versionsnummer på GitHub Releases. Download `RosterMate-1.8.2-macOS.pkg`, og dobbeltklik på filen. Du behøver ikke åbne Terminal.
